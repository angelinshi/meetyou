...
// 头像 — 纯色 + 首字，无角色形象
function Avatar({ size = 36, bg = '#FFB5C8', initial = 'A' }) {
  return (
    <div style={{
      width: size, height: size, borderRadius: '50%',
      background: bg, color: '#fff',
      display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
      fontFamily: MY.font, fontWeight: 600, fontSize: Math.round(size * 0.42),
  ...
  return (
    <div style={{ display: 'inline-flex', alignItems: 'center' }}>
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{
          width: size, height: size, borderRadius: '50%', background: l.bg, color: '#fff',
      ...
      <div style={{ marginLeft: -size * 0.35 }}>
        <div style={{
          width: size, height: size, borderRadius: '50%', background: r.bg, color: '#fff',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontWeight: 600, fontSize: Math.round(size * 0.42),
          border: '2px solid #fff',
        }}>{r.initial}</div>
...
function Phone({ children, bg = MY.surface, statusDark = false }) {
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', inset: '36px 0 24px', overflow: 'hidden' }}>
        {children}
      </div>
  ...
  return (
    <div style={{ background: MY.bg, borderRadius: MY.rsm, padding: '10px 12px' }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 12, color: MY.textTer, marginLeft: 8 }}>💬 评论</span>
      </div>
      {/* comments */}
...
// Home module: compact timeline (first 2 groups) + "查看全部" button
  ...
  return (
    <div style={{ background: MY.surface, borderRadius: MY.rmd, padding: '14px 14px 12px', boxShadow: MY.shadow1 }}>
      ...
      <div style={{ position: 'relative', paddingLeft: 14 }}>
        <div style={{
          position: 'absolute', left: 4, top: 6, bottom: 6, width: 0,
