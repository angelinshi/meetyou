        ...
        <div onClick={onInviteClick} style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ flexShrink: 0, position: 'relative', width: 72, height: 56 }}>
              <div style={{ position: 'absolute', left: 0, top: 2, border: '2.5px solid #fff', borderRadius: '50%', overflow: 'hidden', boxShadow: MY.shadow1 }}>
                <Avatar size={44} bg={USER.bg} initial={USER.initial} />
              </div>
    ...
    <Phone bg="#fff5f8">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
          <div style={{ border: '3px solid #fff', borderRadius: '50%', boxShadow: MY.shadow2, overflow: 'hidden' }}>
            <Avatar size={96} bg={USER.bg} initial={USER.initial} />
          </div>
          <div style={{
      ...
      <div style={{ marginTop: 28, padding: '0 16px' }}>
        <div style={{ fontSize: 15, fontWeight: 500, color: MY.textPri, marginBottom: 12 }}>男友模式</div>
      ...
      <div style={{ position: 'absolute', inset: '44px 0 60px', overflowY: 'auto', padding: '20px 12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 12 }}>
          <div style={{
            ...
            <svg width={29} height={33} viewBox="0 0 36 41" fill="none">
          ...
          <div style={{ maxWidth: '74%' }}>
            ...
            <div onClick={onOpenLink} style={{
              ...
              <div style={{
                ...
                <svg width={35} height={39} viewBox="0 0 36 41" fill="none">
                  <ellipse cx="18" cy="10" rx="7" ry="7.5" fill="rgba(255,255,255,0.92)" />
                  <path d="M11 10 Q11 2 18 2 Q25 2 25 10" fill="rgba(255,255,255,0.92)" />
                  <path d="M11 8 Q9 12 10 16" stroke="rgba(255,255,255,0.92)" strokeWidth="2.5" strokeLinecap="round" />
                  <path d="M25 8 Q27 12 26 16" stroke="rgba(255,255,255,0.92)" strokeWidth="2.5" strokeLinecap="round" />
  ...
  return (
    <Phone bg="#F2F2F7">
      ...
      <div style={{
        ...
        {/* 女生头像 */}
        <div style={{ boxShadow: '0 4px 14px rgba(0,0,0,0.10)', borderRadius: '50%', overflow: 'hidden' }}>
