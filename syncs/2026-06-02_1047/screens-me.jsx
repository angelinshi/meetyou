      ...
      <div style={{ position: 'absolute', top: -36, left: 0, right: 0, height: 246, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', width: 80, height: 54 }}>
            <div style={{ position: 'absolute', left: 0, top: 0, border: '2.5px solid #fff', boxShadow: MY.shadow1, borderRadius: '50%', overflow: 'hidden' }}>
              <Avatar size={48} bg={USER.bg} initial={USER.initial}/>
            </div>
            <div style={{ position: 'absolute', right: 0, bottom: 0, border: '2.5px solid #fff', boxShadow: MY.shadow1, borderRadius: '50%', overflow: 'hidden' }}>
              <Avatar size={48} bg={PARTNER.bg} initial={PARTNER.initial}/>
            </div>
          </div>
          <div>
    ...
    <div style={{ background: MY.surface, borderRadius: MY.rmd, boxShadow: MY.shadow1, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 14px 10px' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, color: MY.textTer, marginLeft: 12, cursor: 'pointer' }}>💬 回复</span>
        </div>
      </div>
